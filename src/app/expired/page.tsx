  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center"
      ...
      <p className="text-sm mb-8 max-w-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.6)' }}>
        Your 14-day free trial is complete. Subscribe to continue accessing your cases, documents, and AI analysis.
      </p>
      <a href="mailto:ajcasemanager46@gmail.com?subject=AJ Suite Subscription"
